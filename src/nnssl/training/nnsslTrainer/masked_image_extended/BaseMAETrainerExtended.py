...
class BaseMAETrainerExtended(AbstractBaseTrainer):
    ...
    def __init__(
        ...
        self.save_bottleneck_features = True
    ...
    def initialize(self):
        ...
        if self.save_bottleneck_features:
    ...
    def build_loss(self):
        ...
        :return:
        """
        return BottleNeckContrastiveLoss(feat_weight=0.1)
